...
class Admin extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $extra['buttons'] = array(
            array(
                ...
                'url' => 'admin/'.$this->module_name.'/edit/-entry_id-'
            ),
            array(
                'label' => lang('global:delete'),
                'url' => 'admin/'.$this->module_name.'/delete/-entry_id-',
                'confirm' => true
            )
        );
        ...
        $this->streams->cp->entries_table('users', 'ug', 15, 'admin/'.$this->module_name.'/index', true, $extra);
    }
    ...
    {
        $this->streams->entries->delete_entry($id, 'users', 'ug');
